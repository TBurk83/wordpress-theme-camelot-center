...
function camelot_enqueues() {
	...
	wp_enqueue_style('font-awesome-css');
  	...
  	wp_register_style('camelot-css', get_template_directory_uri() . '/assets/styles/css/index.css', false, null);
	wp_enqueue_style('camelot-css');
	...
	wp_register_script('camelot-js', get_template_directory_uri() . '/assets/js/camelot.js', false, null, true);
	wp_enqueue_script('camelot-js');

	if (is_singular() && comments_open() && get_option('thread_comments')) {
		wp_enqueue_script('comment-reply');
	}
}
add_action('wp_enqueue_scripts', 'camelot_enqueues', 100);
